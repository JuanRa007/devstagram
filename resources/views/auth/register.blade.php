  ...
  <div class="md:flex md:justify-center md:gap-10 md:items-center">
    ...
    <div class="md:w-1/2 bg-white p-6 rounded-lg shadow-xl">
      <form action=""{{ route('register') }}" method="POST">
        ...
        <input type="submit" value="Crear Cuenta" class="bg-sky-600 hover:bg-sk-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
      </form>
    </div>
  </div>
@endsection